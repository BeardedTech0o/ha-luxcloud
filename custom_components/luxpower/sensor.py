...
async def async_setup_entry(
    ...
    async_add_entities(
        LuxPowerSensor(coordinator, entry, desc)
        for desc in SENSOR_DESCRIPTIONS
    )


class LuxPowerSensor(CoordinatorEntity[LuxPowerCoordinator], SensorEntity):
    """A single LuxPower sensor."""
